...
public class CitizenApplicationRegistrationOperationsController {
	 ...
	 * saveCitizenApplication(@RequestBody CitizenAppRegistrationInputs inputs) {
	 * 
	 * try { // use service int appId = service.registerCitizenApplication(inputs);
	 * if (appId > 0) { return new
	 * ResponseEntity<String>("Citizen Application is Registered with the id::" +
